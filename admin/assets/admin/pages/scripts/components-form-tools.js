        ...
        $('#tags_1').tagsInput({
            ...
            'onAddTag': function () {
               // alert(1);
				...
				var product_tag='';
				$('#tags_1_tagsinput span.tag span').each(function(i)
				{
				var val=$(this).text(); // This is your rel value
				 //alert(val);
				 product_tag+=$.trim(val)+",";
				});
				product_tag=product_tag.slice(0,-1)
				//alert(product_tag);
				document.getElementById("product_tag").value=product_tag;
