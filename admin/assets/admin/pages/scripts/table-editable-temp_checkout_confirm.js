var TableEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
			...
			jqTds[4].innerHTML = '<input type="text" class="form-control input-small main_category" name="quantity" id="quantity" value="' + aData[4] + '">';
        ...
        function saveRow(oTable, nRow,str) {
		   ...
		   $('#show_subtotal_div').html(temp_div);
			...
			oTable.fnUpdate(quantity, nRow, 5, false);
