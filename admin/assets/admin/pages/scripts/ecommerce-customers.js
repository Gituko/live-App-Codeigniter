var EcommerceCustomers = function () {
    ...
    var handleProducts = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                "lengthMenu": [
                    ...
                    [10, 20, 50, 100, 150, 200, 250] // change per page values here 
                ],
                "pageLength": 10, // default record count per page
                "ajax": {
                    /*"url": "demo/ecommerce_products.php", // ajax source*/
					"url": ""+site_base_url+"customer_list", // ajax source
                },
                "order": [
                    [1, "asc"]
        ...
        grid.getTableWrapper().on('click', '.table-group-action-submit', function (e) {
			...
			$.ajax({
			type: "POST",
			url: ""+site_base_url+"action_customer",
