	...
	$(document).ready(function() {
		if( $.fn.sheepIt ) {
			...
			$('#event_cloning').sheepIt({
				separator: '', 
				data: [
					   /*{ res_member_date: '10/31/2012', }, */
					   { res_mem_reg_date: document.getElementById('hid_mem_reg_date').value, res_mem_exp_date: document.getElementById('hid_mem_exp_date').value}, 
