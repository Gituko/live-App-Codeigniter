...
/*====================================== SETTING PART =====================================================	*/
	...
	public function update_setting($setting_id)
	{
			...
			if($setting_id=='22')
				{
					...
					$dollar=$this->input->post('dollars');
					$point_dollar=$point."/".$dollar;
					$data_to_store = array(
				        'setting_value'=>$point_dollar
						);
			...
			else if($setting_id=='42')
			{
					
					
					$setting_value=$this->input->post('gretting_content').'@@.//.@@'.$this->input->post('greeting_sign');
					$data_to_store = array(
					'setting_value' =>$setting_value
					);	
...
public function delete_user($id='')
 ...
 public function advertisement()
	   ...
	   if ($this->input->server('REQUEST_METHOD') === 'POST')
			{
				...
				$advertisement_place=$this->input->post('ad_place');
	...
	{
		   $image_name='advertisement_image';
		   $path='advertisement_image';
		 
		 
		 		
	$advertisement_image=imageupload_with_crop($image_name,$path,861,73);
