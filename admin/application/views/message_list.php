			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/pagecontent">Pagecontent</a>							
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
						
					</ul>
				<?php /*?>	<ul class="page-breadcrumb back_btn">
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i>Editable PageContent</div>
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									  $message_id=stripslashes($details[$i]['message_id']);
									  $message=stripslashes($details[$i]['message']);
							
							   $sender_type=stripslashes($details[$i]['sender_type']);
							    $user_id=stripslashes($details[$i]['user_id']);
								 $artist_id=stripslashes($details[$i]['artist_id']);
								 $message_time=stripslashes($details[$i]['message_time']);
							   
							   //$type_language=stripslashes($details[$i]['type_language']);
							   
							    if($sender_type=='User'){
										 $detail = $this->module->get_detail_user_img($user_id);
										 
										 
										 }else{
												 $detail = $this->module->get_detail_artist_img($artist_id); 
								...
								<tr>
                                     <td style="visibility:hidden;display:none;"><?=$message_id?></td>
									<td>
										 <?=$message?>
									</td>
									...
									<td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/edit_message/<?=$message_id?>">
										Edit </a>
                                    ...
                                    <td>
										<!--<a class="edit" href="javascript:;">
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/delete_message/<?=$message_id?>">
										Delete </a>
									...
									<?php /*?><td>
                                        ...
                                        <a  href="<?php echo base_url();?>main/delete_cat/<?=$cat_id?>">
										Delete </a>
									</td><?php */?>
