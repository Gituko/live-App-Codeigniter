...
<!--						<li>
							<a href="<?php echo base_url(); ?>main/category_list">Category Details</a>							
                            <i class="fa fa-angle-right"></i>
						</li>-->
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									  $category_id=stripslashes($details[$i]['category_id']);
									  $category_name=stripslashes($details[$i]['category_name']);
									    $cat_image=stripslashes($details[$i]['cat_image']);
								...
								<tr>
                                     <td style="visibility:hidden;display:none;"><?=$category_id?></td>
									<td>
										 <?=$category_name?>
									</td>
                                 <!-- <td>
                                  <img src ='<?php echo site_base_url('uploads/cat_image/'. $cat_image); ?>' width='100' height='80'>
                                  </td>-->
									...
									<td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/edit_category/<?=$category_id?>">
										Edit </a>
									...
									<td>
                                    	...
                                    	Delete </a>-->
                                        <a  href="<?php echo base_url();?>main/delete_category/<?=$category_id?>">
										Delete </a>
									</td>
