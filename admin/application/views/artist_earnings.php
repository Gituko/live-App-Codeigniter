...
<div class="container">
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<h3 class="page-title">
				 Earnings of <?=$artist_name[0]['name']?> <small></small>
				</h3>
				<div class="page-bar">
					<ul class="page-breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i>Arist Earnings
						</li>
 ...
 .border_btm{
	 border-bottom:1px solid #dedede;
            ...
            <div class="col-md-4"><font size="3" color="black">Total Earnings : </font><font size="3" color="red">$<?=$total_amount[0]['total']?></font></div><div class="col-md-2"></div>  
            <div class="col-md-2"><font size="3" color="black">Recorded  Video: </font><font size="3" color="red">$<?=$recorded[0]['total']?></font></div><div class="col-md-2"></div>          
         
          <div class="col-md-2"><font size="3" color="black">Streaming  Video :</font><font size="3" color="red">$<?=$stream[0]['total']?></font></div><div class="col-md-2"></div>                       
