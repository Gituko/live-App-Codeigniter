...
<?=$meta_tag;?><!-- BEGIN GLOBAL MANDATORY STYLES -->
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/artist_list">Artist Details  </a><i class="fa fa-angle-right"></i>Artist photo list						
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									  $image_id=stripslashes($details[$i]['image_id']);
									  $image_name=stripslashes($details[$i]['image_name']);
						...
						<div class="details">
							<a  href="<?php echo base_url();?>main/delete_artist_image_list/<?=$artist_id?>/<?=$image_id?>">
							 <img src ='<?php echo site_base_url('admin/assets/global/img/remove-icon-small.png'); ?>' width='10' height='10'>
                             </a>
						</div>
							<? if($image==''){?>
									  <img src ='<?php echo site_base_url('uploads/user_photo/blank_images.gif'); ?>' width='210' height='180'>
                                       
								 <? }else{?>
                                 <img src ='<?php echo site_base_url('uploads/user_photo/'. $image); ?>' width='210' height='180'>
                                  <? }?>
