							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 for($i=0;$i<count($details);$i++)
								 {
										...
										$artist_name=stripslashes($details[$i]['name']);
										$recorded_video_name=stripslashes($details[$i]['recorded_video_name']);
										$category_name=stripslashes($details[$i]['category_name']);
										$video_tags=stripslashes($details[$i]['video_tags']);
								...
								<tr>
                                   ...
                                   <td>
                                   <center>
                                  <video width="220" height="190" controls controlsList="nodownload">
                      <source src="<?php echo site_base_url();?>uploads/recorded_video/<?=$recorded_video_name?>" type="video/mp4" />
                      <source src="<?php echo site_base_url();?>uploads/recorded_video/<?=$recorded_video_name?>" type="video/ogg" />
                      <source src="<?php echo site_base_url();?>uploads/recorded_video/<?=$recorded_video_name?>" type="video/flv" />
                    </video>
                                 <p><strong>Overview</strong>: <?=$recorded_v_overview?></p>
                                  <p><strong>Video Tags</strong>: <?=$video_tags?></p>
                                 </center>
                                  </td>
									<td>
									 <?=$category_name?>
