...
$total_no_images=$this->module->get_all_images();
$total_no_images=count($total_no_images);

$total_no_normal_videos=$this->module->get_all_normal_videos();
$total_no_normal_videos=count($total_no_normal_videos);

$total_no_recorded_videos=$this->module->get_all_recorded_videos();
$total_no_recorded_videos=count($total_no_recorded_videos);
?>
