                    ...
                    <div class="col-lg-6">
                        <form id="frmMoneda">
                            <div class="form-group">
                                ...
                                <input name="nombre" type="text" class="form-control validate[required]"  placeholder="Nombre de la moneda">
<!--                                          <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                            </div>
                            <div class="form-group">
                                <label >Valor</label>
                                <input type="text" name="valor"  class="form-control validate[required,custom[integer]]"  placeholder="Valor">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control validate[required]" name="referencia">
                                    ...
                                    <?php
                                    foreach ($moneda as $k) {
                                        echo '<option value="' . $k->id . '">' . $k->moneda . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
...
<?php $this->load->view("footer"); ?> 
    ...
    <script>
        ...
        function grabarMoneda() {
            ...
            $enviar.url="add_conversions_money";
...
//                $.post("add_conversions_money",$("#frmMoneda").serialize()+"&action=json",function(data){                    
