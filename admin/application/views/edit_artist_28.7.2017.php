        ...
        <div class="tab-pane active" id="tab_general">
			...
			?>
                    ...
                    * </span>
					...
					{
					?>
                    <input type="password" class="form-control" name="password" id="password" placeholder="" readonly="readonly" value="<?=$password;?>" >
...
<input type="checkbox" name="interested_in[]" value="<?php echo $int_ex[$i]?>" <?php if($int_ex1[$j]==$int_ex[$i]){ $j=$j+1;?>checked<? } ?>><?php echo $int_ex[$i]?>
       ...
       <!-----------------------------------------------------album--------------------------------------------------------------->             
            ...
            <!------------------------------------------------end-----album--------------------------------------------------------------->                   
           <?php
		   $category=$this->module->get_category_for_artist()
           ...
           <div class="form-group">
                    ...
                    * </span>
                    ...
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium" name="category_type" id="category_type" >
                    <option value="">Select</option>
                    <?php
					foreach($category as $row)
					{
						?>
                    <option value="<?=$row['category_id']?>" <? if($category_type==$row['category_id']) { ?> selected <? } ?>><?=$row['category_name']?></option>
