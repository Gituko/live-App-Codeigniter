...
<div class="container">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
                        ...
                        <li>
							...
							<i class="fa fa-angle-right"></i>User Following
						</li>
 ...
 .border_btm{
	 border-bottom:1px solid #dedede;
            ...
            <div class="col-md-4"><font size="3" color="black">Total Artist Following : </font><font size="3" color="red"><?=$total;?></font></div><div class="col-md-2"></div>  
