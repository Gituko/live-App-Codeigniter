	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">				
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">
				Video  Edit <small> edit Video</small>
			  </h3>
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/admin_video_list">Video List</a>
				...
				<div class="row">
					...
					if(!empty($details) && $page_id!='')
			          {
						  $form_action="main/update_admin_video/".$page_id;
					  }
					  else
					  {
						  $form_action="main/admin_add_video";
					  }
					?>
        ...
        <div class="tab-pane active" id="tab_general">
			...
			?>
                    ...
                    * </span>
                    ...
                    <i class="fa"></i>
                    <input type="text" class="form-control validate[required]" name="title" id="page_title" placeholder=""  value="<?=$title;?>" >
                    </div>
                    </div>  
                    </div>
                    ...
                    <textarea class="ckeditor form-control validate[required]" name="overview" id="page_content"rows="6" data-error-container="#editor2_error"><?=$overview;?></textarea>
                    ...
                    * </span><span> </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="file" name="video_name" id="image" > 
                    <input type="hidden" class="form-control" name="hid_image" id="hid_image" placeholder=""  value="<?=$video_name;?>">
						<?php /*?><div class="col-md-4 small">
						<?php
                        if($video!='')
                        {
                        ?>
