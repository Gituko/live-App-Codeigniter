...
<head>
<?php
$page_name='artist_schedule_list';
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/artist_list">Artist Details > </a>Artist Schedule list						
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									  $schedule_id=stripslashes($details[$i]['schedule_id']);
									  $date=stripslashes($details[$i]['date']);
									  $time=stripslashes($details[$i]['time']);
									    $duration=stripslashes($details[$i]['duration']);
										
									 $intro_text=stripslashes($details[$i]['intro_text']);
