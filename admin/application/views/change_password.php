...
<!--=============================================Start Validation===========================================-->
<script src="<?php echo base_url();?>js/jquery-1.5.2.min.js" type="text/javascript" language="javascript" charset="UTF-8"></script>
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
					<form class="form-horizontal form-row-seperated" id="form_sample_password" name="form_sample_password"  enctype="multipart/form-data" method="post" action="<?=base_url();?>main/change_password">
                    <?php
                                        if(isset($exist_message)){
                                        if($exist_message == TRUE)
                                        {
                                        ?>
                                        <div class="alert alert-error">
                                        <strong>Oh snap!</strong> Old Password does not match.Please give your Old Password.
                                        </div>
                                        <? } } ?>
                                        ...
                                        <strong>Well done!</strong>Your Password has been Updated Successully.
                                        </div>
                                        <? }else{ ?>
                                        <div class="alert alert-error">
        ...
        <div class="tab-pane active" id="tab_general">
            <div class="form-body">
             ...
             <div class="form-group">
                    <label class="col-md-2 control-label" style="text-align:left;">Old Password: <span class="required">
                     </span>
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" style="text-align:left;">New Password: <span class="required">
                     </span>
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" style="text-align:left;">Confirm Password: <span class="required">
                   </span>
                    </label>
                    <div class="col-md-10">
                    ...
                    <div class="input-icon right">
                     <i class="fa"></i>
                      <input type="password" class="form-control" name="confirm_password" id="confirm_password" value=""> <br />
                      <button style="margin-top:10px;" class="btn green-haze btn-circle"><i class="fa fa-check"></i> Reset Password</button>
						</div>
...
<script src="<?php echo base_url();?>assets/admin/pages/scripts/form-validation-change_password.js"></script>
<!-- END PAGE LEVEL STYLES -->
<script>
