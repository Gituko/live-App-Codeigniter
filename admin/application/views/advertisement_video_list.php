			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/admin_video_list">Advertisement Video List</a>							
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 for($i=0;$i<count($details);$i++)
								 {
									  ...
									  $video_title=stripslashes($details[$i]['video_title']);
							 		  $video=stripslashes($details[$i]['video']);
							   ...
							   //$type_language=stripslashes($details[$i]['type_language']);
									 ...
									 //$page_status=stripslashes($details[$i]['status']);
								...
								<tr>
                                     <td style="visibility:hidden;display:none;"><?=$video_id?></td>
									<td>
										 <?=$video_title?>
									</td>
                     ...
                     <source src="<?=site_base_url()."uploads/advertisement_video/".$video;?>" type="video/mp4" />  
									...
									<td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/update_advertisement_video/<?=$video_id?>">
										Edit </a>
                                    ...
                                    <td>
										<!--<a class="edit" href="javascript:;">
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/delete_advertisement_video/<?=$video_id?>">
										Delete </a>
