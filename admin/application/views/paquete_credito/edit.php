                        ...
                        <form id="frm">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <img class="img-fluid" style="width: 70px; height: 70px;" src="<?php echo site_base_url(); ?>uploads/coin_image/<?php echo $paquete->icon; ?>" alt="">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input name="name" value="<?php echo $paquete->name; ?>" type="text" class="form-control validate[required]"  placeholder="Name"> 
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <label>Equals note</label>                                    
                                    <input type="text" value="<?php echo $paquete->equals_note; ?>" name="equals_note" class="form-control validate[required,custom[integer]]"  placeholder="Equals note">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label >Sale price (dls)</label>
                                    <input type="text" name="sale_price" value="<?php echo number_format($paquete->sale_price,2); ?>"  class="form-control validate[required,custom[number]]" placeholder="Sale price (dls)" >
                                </div>                                
                            </div>
                            <div class="col-lg-12">
        ...
        function save() {
            ...
            $enviar.formdata({form:"#frm"}).onreadystatechange=function(){
               ...
               if (that.readyState == 4 && that.status == 200) {
                    ...
                    if(msg.tipo=="success"){
                        setTimeout(function(){
                            window.location.href="<?php echo base_url() ?>paquete_credito/index";
                        },3000);                        
                    }
                }
            };
