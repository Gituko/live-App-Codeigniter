			...
			<div class="page-content">
				...
				<div class="row">
					...
					//if(!empty($details) && $meta_id!='')
			          //{
						  $form_action="main/edit_message/".$message_id;
					 // }
					//  else
					 // {
        ...
        <div class="tab-pane active" id="tab_general">
           ...
           <?php /*?> <?php
			...
			?><?php */?>
                    ...
                    <label class="col-md-2 control-label">Message<span class="required">
                    * </span>
                    </label>
                    ...
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="message" id="message" placeholder=""  value="<?=$details[0]['message'];?>" >
                    </div>
                    </div>  
                    </div>
                    ...
                    * </span>
                    ...
                    <?
                    $status=$details[0]['message_status'];
					?>
                    
                    
                    
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium" name="status" id="meta_status" >
