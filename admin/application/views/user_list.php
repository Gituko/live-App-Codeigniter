			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/user_list">User Details</a>							
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
								 ...
								 <? }else{?>
                                  ...
                                  <? }?>
                                    ...
                                    <td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/user_purchase/<?=$user_id?>">
										Purchase </a>
                                    ...
                                    <td>
                                        ...
                                        <a  href="<?php echo base_url();?>main/user_following/<?=$user_id?>">
										Following </a>
                                    ...
                                    <td>
                                     ...
                                     <td>
										  <a  href="<?php echo base_url();?>main/edit_password/User/<?=$user_id?>">
										Edit </a>
									</td>
