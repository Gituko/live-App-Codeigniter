...
<head>
<link type="images/favicon" href="<?php echo base_url();?>img/" rel="shortcut icon" /> 
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form id="login_form" name="login_form" method="post" class="login-form" action="http://www.observum.com:8080/main/login" >
    <?php
	if($check=='wrong')
	{
	?>
   ...
   Your registration is successfully done.
	...
	?>
		...
		<div class="form-actions">
         ...
         <input type="checkbox" name="remember_me" id="remember_me" value="1 <?php if($this->input->cookie('admin_user_name')!='') { ?> checked="checked" <? } ?>>
Remember me </label>-->
            ...
            <input type="submit" name="input" class="btn green pull-right submit_bt" value="Login" ><br />
             ...
             <a href="<?php echo base_url(); ?>main/signup" title="Forgot Password">Sign Up</a><br/>
