			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/pagecontent">List</a>							
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-edit"></i> RECORDED VIDEOS PAYMENT REPORT</div>
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 for($i=0;$i<count($details);$i++)
								 {
									  ...
									  $video_title=stripslashes($details[$i]['recorded_v_title']);
									  $name=stripslashes($details[$i]['name']);
							$price=stripslashes($details[$i]['price']);
							$total=stripslashes($details[$i]['total']);
							$total_price=stripslashes($details[$i]['total_price']);
							   ...
							   //$type_language=stripslashes($details[$i]['type_language']);
								...
								<tr>
                                    ...
                                    <td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/recorded_video_view/<?=$video_id?>">
										View </a>
