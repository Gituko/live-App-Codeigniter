						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									    $image=stripslashes($details[$i]['photo_image']);
								...
								<tr>
                                   ...
                                   <td>
                                   <center>
                                  <img src ='<?php echo site_base_url('uploads/user_photo/'. $image); ?>' width='200' height='100'>
                                 <p> <?=$image_name?></p>
                                 </center>
                                  </td>
									<td>
									 
									<a href="<?php echo base_url();?>main/delete_photo_album/<?=$image_id?>">
										Delete </a>
                                    </tr>
								</tr>
