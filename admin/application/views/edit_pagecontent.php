<?php
if(@$admin_type=='1'){
	if($this->uri->segment(2)=='add_pagecontent'){
		$permission=$list_permission[0]['permission_add'];
	}
	if($this->uri->segment(2)=='edit_pagecontent'){
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">
				Pagecontent  Edit <small> edit Pagecontent</small>
			  </h3>
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/pagecontent">Pagecontent List</a>
				...
				<div class="row">
					...
					if(!empty($details) && $page_id!='')
			          {
						  $form_action="main/update_pagecontent/".$page_id;
					  }
					  else
					  {
						  $form_action="main/add_pagecontent";
					  }
					?>
        ...
        <div class="tab-pane active" id="tab_general">
            ...
            <?php
			   if(!empty($details) && $page_id!='')
			   {
				   ...
				   $page_title=stripslashes($details[0]['page_title']);
				   $page_content=stripslashes($details[0]['page_content']);
			...
			?>
                    ...
                    <label class="col-md-2 control-label">Pagecontent Title: <span class="required">
                    * </span>
                    </label>
                    ...
                    <i class="fa"></i>
                    <input type="text" class="form-control validate[required]" name="page_title" id="page_title" placeholder=""  value="<?=$page_title;?>" >
                    </div>
                    </div>  
                    </div>
                    ...
                    <textarea class="ckeditor form-control validate[required]" name="page_content" id="page_content"rows="6" data-error-container="#editor2_error"><?=$page_content;?></textarea>
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label">Pagecontent Image: <span class="required">
                    * </span><span>Image Crop Size 800x460 </span>
                    ...
                    <input type="hidden" class="form-control" name="hid_image" id="hid_image" placeholder=""  value="<?=$image;?>">
						<div class="col-md-4 small">
						<?php
                        if($image!='')
                        {
                        ?>
                       <img src="<?=site_base_url()."uploads/pagecontent_image/thumb/thumb_".$image;?>"> 
                       <?
                        }
                       ?>
                       </div>
                    ...
                    * </span>
                    ...
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium validate[required]" name="status" id="status" >
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="file" name="pagecontent_image" id="pagecontent_image" value="<?=$pagecontent_image;?>" class="validate[required]"> 
                    <input type="hidden" class="form-control" name="hid_pagecontent_image" id="hid_pagecontent_image" placeholder=""  value="<?=$pagecontent_image;?>" >
						<?php
                        if($pagecontent_image!='')
                        {
                        ?>
                       <img src="<?=site_base_url()."uploads/pagecontent_image/".$pagecontent_image;?>"> 
                       <?
                        }
                       ?>
                    </div>
                    (190 X 281 Dimentions) 
                    </div>  
                    </div>-->
