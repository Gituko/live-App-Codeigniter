...
<link type="images/favicon" href="<?php echo base_url();?>assets/admin/layout2/img/''" rel="shortcut icon" /> 
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">
				Setting List <small>Setting </small>
				</h3>
				<div class="page-bar">
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<!--<i class="fa fa-edit"></i>Editable Business Types-->
                                    Setting List
								</div>
								<div class="tools">
							...
							<div class="portlet-body">
								...
								<tr role="row" class="heading">
										...
										<th width="15%">Page Position</th>
                                        <th width="15%">Price</th>
                                          <th width="15%">Dimensions(width X height)</th>
                                ...
                                <?
								 ...
								 {
									$add_id=stripslashes($details[$i]['add_id']);
									$page_postion=stripslashes($details[$i]['page_postion']);
									$price=stripslashes($details[$i]['price']);
									$size=stripslashes($details[$i]['size']);
								...
								<tr>
                                      ...
                                      <td style="visibility:hidden;display:none;"><?=$setting_id?></td>
                                     <td><?=$page_postion?></td>
                                    <td><?=$price?></td>
                                    <td><?=$size?></td>
                                    <td>
									<a href="<?=base_url();?>main/edit_add_price_setting/<?=$add_id;?>" class="btn btn-xs default btn-editable"><i class="fa fa-pencil"></i> Edit</a>
...
<script src="<?php echo base_url();?>assets/admin/pages/scripts/table-editable-customer.js"></script>
<script>
