			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/artist_list">Artist Details > </a>Artist photo list						
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
							...
							<div class="portlet-body">
								...
								<tr>
                                    ...
                                    <td>
                                     ...
                                     <? if($image==''){?>
									  <img src ='<?php echo site_base_url('uploads/user_photo/blank_images.gif'); ?>' width='100' height='80'>
                                       
								 <? }else{?>
                                 <img src ='<?php echo site_base_url('uploads/user_photo/'. $image); ?>' width='100' height='80'>
                                  <? }?>
