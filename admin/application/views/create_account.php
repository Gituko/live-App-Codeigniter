...
function validation()
{
	...
	if(admin_name=='')
	{
		...
		$('p#admin_contactno').html("");
		$('p#admin_image').html("");
		$('p#admin_name').html("Please Enter Full Name");
		return false;
	}
	if(admin_password=='')
	{
...
<div style="height:10px;text-align:right;">
	...
	<!-- BEGIN LOGIN FORM -->
       <?php
            if(isset($email_flash_message)){
        if($email_flash_message == FALSE)
        {
		?>
         <p>
            <strong><font color="#FF0000">Your Registration! is successfully done Confirmation Email has send to your email id.</font></strong>
          </p>
<?php } } ?>
        <?php
        //flash messages
        if(isset($email_flash_message)){
        if($email_flash_message == TRUE)
        {
        ?>
       <p>
      <strong><font color="#FF0000">Your Enter Email Id Was Already Registrated.Please Enter Another Email Id </font> </strong> 
        </p>
        <?php } } ?> 
   ...
   Wrong Username & password
	...
	?>
        ...
        <div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter Fullname" id="admin_name" name="admin_name" />
                
			</div>
            <p style="color:#F00" id="admin_name">
		</div>
        <!-------------------------------------------->
		<div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                   ...
                   <!-- <p style="color:#F00" id="admin_image">-->
                    ...
                    <div class="input-icon right">
                    <select class="table-group-action-input form-control input-medium" name="admin_status" id="admin_status" required >
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 <?=date('Y')?> &copy; Streaming Admin Dashboard.
</div>
<!-- END COPYRIGHT -->
