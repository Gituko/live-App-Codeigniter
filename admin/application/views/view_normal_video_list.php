			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-12">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 for($i=0;$i<count($details);$i++)
								 {
										...
										$video_overview=stripslashes($details[$i]['video_overview']);
                      ...
                      <source src="<?php echo site_base_url();?>uploads/arists_video/<?=$video_name?>" type="video/mp4" />
                      <source src="<?php echo site_base_url();?>uploads/arists_video/<?=$video_name?>" type="video/ogg" />
                      <source src="<?php echo site_base_url();?>uploads/arists_video/<?=$video_name?>" type="video/flv" />
                    </video>
                                 <p><strong>Overview</strong>: <?=$video_overview?></p>
                                 </center>
                                  </td>
									<td>
									 
									<a href="<?php echo base_url();?>main/delete_video_album/<?=$video_id?>">
										Delete </a>
                                    </tr>
								</tr>
