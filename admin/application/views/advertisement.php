	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<h3 class="page-title">
				Advertisement list <small>editable Advertisement samples</small>
				</h3>
				<div class="page-bar">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								//echo "<pre>"; print_r($details); die;
								 ...
								 {
									    $advertisement_name=stripslashes($details[$i]['advertisement_name']);
										$advertisement_status=stripslashes($details[$i]['advertisement_status']);
										$advertisement_id=stripslashes($details[$i]['advertisement_id']);
										$advertisement_page=stripslashes($details[$i]['page']);


								if($advertisement_status=='Active')
									 {
										 $label_type='success';
									 }
									 else
								...
								?>
								<tr>
                                     <td style="visibility:hidden;display:none;"><?=$advertisement_id?></td>
									<td>
										 <?=$advertisement_name?>
									</td>
                                    ...
                                    <?=ucfirst(str_replace("_"," ",$advertisement_page));?>
										
									</td>
                                 
                                                                        <td>
                                                                            <?php echo date("m-d-Y",  strtotime($details[$i]['advertisement_start_date']))?>
									</td>
                                                                        <td>
                                                                            <?php echo date("m-d-Y",  strtotime($details[$i]['advertisement_end_date']))?>
									</td>
									<td>
                                         <span class="label label-sm label-<?=$status_list[$advertisement_status];?> "> 
										 
										 <?=$advertisement_status?> </span>
										 
									</td>
									<td>
										
                                        <a  href="<?php echo base_url();?>main/edit_advertisement/<?=$advertisement_id?>">
										Edit </a>
                                       
									</td>
									<td>
										<a href="<?php echo base_url();?>main/delete_advertisement/<?=$advertisement_id?>">
										Delete </a>
									</td>
