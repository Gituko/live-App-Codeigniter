...
<head>
<link type="images/favicon" href="<?php echo base_url();?>img/logo0.png" rel="shortcut icon" /> 
...
function validation()
{
	...
	var admin_email = document.getElementById('admin_user_email').value;
	var admin_user_name = document.getElementById('admin_user_name').value;
	var admin_password = document.getElementById('admin_password').value;
	var admin_conpassword = document.getElementById('admin_conpassword').value;
	...
	if(admin_conpassword=='')
	{
	  $('p#admin_conpassword').html("Please Enter Confirm password");
	}
	...
	{
	  $('p#pass_match').html("Please Enter admin password and confirm password must be same.");
	  return false;
	}
	
	if((admin_email && admin_user_name && admin_password && admin_conpassword)=='')
	{
		return false;
	}
	if((admin_email && admin_user_name && admin_password && admin_conpassword)!='')
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form id="login_form" name="login_form" method="post" class="login-form" action="<?php echo base_url(); ?>main/signup" >
    <?
	if($check=='wrong')
	{
	?>
   ...
   Wrong Username & password
	...
	?>
        ...
        <p style="color:#F00" id="pass_match">
        ...
        <div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="admin_user_email" id="admin_user_email" value="<?=$this->input->cookie('admin_user_name')?>"/>
			</div>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="admin_user_name" id="admin_user_name" value="<?=$this->input->cookie('admin_user_name')?>"/>
			</div>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="admin_password" id="admin_password" value="<?=$this->input->cookie('admin_password')?>"/>
			</div>
        ...
        <div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-lock"></i>
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirm Password" name="admin_conpassword" id="admin_conpassword" value="<?=$this->input->cookie('admin_password')?>"/>
			</div>
            <p style="color:#F00" id="admin_conpassword">
		</div>
