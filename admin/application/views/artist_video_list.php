			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/artist_list">Artist Details</a> >Artist video list						
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									  $video_id=stripslashes($details[$i]['video_id']);
									  $video_title=stripslashes($details[$i]['video_title']);
									  $video_name=stripslashes($details[$i]['video_name']);
									    $artist_id=stripslashes($details[$i]['artist_id']);
										
									 $video_status=stripslashes($details[$i]['video_status']);
						...
						<div class="details">
							<a  href="<?php echo base_url();?>main/delete_artist_video_list/<?=$artist_id?>/<?=$video_id?>">
                     ...
                     <video width="220" height="190" controls>
                      <source src="<?=$url[0]?>uploads/arists_video/<?=$video_name?>" type="video/mp4" />
                      <source src="<?=$url[0]?>uploads/arists_video/<?=$video_name?>" type="video/ogg" />
                      <source src="<?=$url[0]?>uploads/arists_video/<?=$video_name?>" type="video/flv" />
                    </video>
						</a>
                        <div class="f_video_bottom">
                                        <h5>
                                        <a title="overview" class="iframe_review" href="<?php echo base_url();?>main/overview_normal_video?video_id=<?=$video_id;?>" align="right">Overview</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                       
                                        <a title="overview" class="iframe_review" href="<?php echo base_url();?>main/edit_normal_video?video_id=<?=$video_id;?>&artist_id=<?=$artist_id?>" align="right">Edit</a>  
