        ...
        <div class="tab-pane active" id="tab_general">
            ...
            <?php
			   if(!empty($details) && $id!='')
			   {
					...
					$artist_tag=stripslashes($details[0]['artist_tag']);
					...
					$password=stripslashes($details[0]['password']);
					$live_video=stripslashes($details[0]['live_video']);
					$recorded_video=stripslashes($details[0]['recorded_video']);
					$live_recorded_video=stripslashes($details[0]['live&recorded_video']);
					$category_type=stripslashes($details[0]['category_type']);
					$paypal_id=stripslashes($details[0]['paypal_id']);
			...
			?>
                  ...
                  <?php
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="birth_date" id="datetimepicker1" placeholder=""  value="<?=$birth_date;?>" >
                    </div>
                    </div> 
                    </div>
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label">PayPal id: <span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="paypal_id"  placeholder=""  value="<?=$paypal_id;?>" >
                    </div>
                    </div> 
                    </div>
                    ...
                    * </span>
                    ...
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium" name="sex" id="sex" >
                    <option value="">Select</option>
                    <option value="male" <? if($sex=='male') { ?> selected <? } ?>>Male</option>
                    <option value="female" <? if($sex=='female') { ?> selected <? } ?>>Female</option> 
                     <option value="others" <? if($sex=='others') { ?> selected <? } ?>>Others</option>                 
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label"> Edit Tag: <span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="artist_tag" id="artist_tag" placeholder=""  value="<?=$artist_tag;?>" >
                    </div>
                    </div> 
                    </div>
...
<input type="checkbox" name="interested_in[]" value="<?php echo $int_ex[$i]?>" <?php if($int_ex1[$j]==$int_ex[$i]){ $j=$j+1;?>checked<? } ?>><?php echo $int_ex[$i]?>
                 ...
                 <div class="form-group">
                    <label class="col-md-2 control-label"> About Me: <span class="required">
                    * </span>
                    </label>
       ...
       <!-----------------------------------------------------album--------------------------------------------------------------->             
            ...
            <!------------------------------------------------end-----album--------------------------------------------------------------->                   
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label"> Live Video: <span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="live_video" id="live_video" placeholder=""  value="<?=$live_video;?>" >
                    </div>
                    </div> 
                    </div>
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label"> Recorded Video: <span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="recorded_video" id="recorded_video" placeholder=""  value="<?=$recorded_video;?>" >
                    </div>
                    </div> 
                    </div>
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label"> Live & Recorded: <span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="live_recorded_video" id="live_recorded" placeholder=""  value="<?=$live_recorded_video;?>" >
                    </div>
                    </div> 
                    </div>
