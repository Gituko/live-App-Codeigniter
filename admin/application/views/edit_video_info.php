    ...
    margin-bottom: 10px;
				...
				<div class="row">
                    ...
                    <?php
						  ...
						  $form_action="main/update_normal_video_info/";
					?>
        ...
        <div class="tab-pane active" id="tab_general">
            <div class="form-body">
				   ...
				   <?php
					 ...
					 $name=stripslashes($details[0]['video_title']);
					$overview=stripslashes($details[0]['video_overview']);
					$category=stripslashes($details[0]['category_type']);
					$tag=stripslashes($details[0]['video_tags']);
					
					$status=stripslashes($details[0]['video_status']);
