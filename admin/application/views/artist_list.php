			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/artist_list">Artist Details</a>							
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<tr>
                                  ...
                                  <td>
                                  <? if($image==''){?>
									  <img src ='<?php echo site_base_url('uploads/user_image/blank_images.jpg'); ?>' width='100' height='80'>
								 <? }else{?>
                                  ...
                                  <? }?>
                                     ...
                                     <td>
										<?php /*?><a  href="<?php echo base_url();?>main/artist_add_image/<?=$artist_id?>">
										Add </a><br/><br/><?php */?>
                                        <a  href="<?php echo base_url();?>main/artist_list_image/<?=$artist_id?>">
										List </a>
									</td>
                                     <td>
										<?php /*?><a  href="<?php echo base_url();?>main/artist_add_video/<?=$artist_id?>">
										Add </a><br/><br/><?php */?>
                                        <a  href="<?php echo base_url();?>main/artist_list_video/<?=$artist_id?>">
										List </a>
									</td>
                                    ...
                                    <td>
										<?php /*?><a  href="<?php echo base_url();?>main/artist_add_r_video/<?=$artist_id?>">
										Add </a><br/><br/><?php */?>
                                        <a  href="<?php echo base_url();?>main/artist_list_r_video/<?=$artist_id?>">
										List </a>
									</td>
                                    
                                  <?php /*?>  <td>
										
                                        <a  href="<?php echo base_url();?>main/artist_list_schedule/<?=$artist_id?>">
										List </a>
									</td><?php */?>
                                    ...
                                    <td>
                                        ...
                                        <a  href="<?php echo base_url();?>main/artist_earnings/<?=$artist_id?>">
										Earnings </a>
									</td>
                                    ...
                                    <td>
                                        ...
                                        <a  href="<?php echo base_url();?>main/artist_followers/<?=$artist_id?>">
										Followers List </a>
									</td>
									...
									<td>
                                         <span class="label label-sm label-<?=$status_list[$status];?>"> <?=$status?> </span>
										 
									</td>
                                     <td>
										  <a  href="<?php echo base_url();?>main/edit_password/Artist/<?=$artist_id?>">
										Edit </a>
									</td>
									...
									<td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/edit_artist/<?=$artist_id?>">
										Edit </a>
									...
									<td>
                                    	...
                                    	Delete </a>-->
                                        <a  href="<?php echo base_url();?>main/delete_artist/<?=$artist_id?>">
										Delete </a>
									</td>
