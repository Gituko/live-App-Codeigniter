...
/***********************************************************12.09.17*****************************/
function get_advertisement_video_list(){
	
	
					$this->db->select('*');
					$this->db->from('stream_advertisement_video');
...
function insert_advertistment_video($data)
	{
		$insert = $this->db->insert('stream_advertisement_video', $data);
		//echo $this->db->last_query();die;
		return $this->db->insert_id();
	}	
	
function update_advertisement_video($id,$data)
	{
		
		$this->db->where('video_id', $id);
		$this->db->update('stream_advertisement_video', $data);
		return $id;
	}	
	
function get_advideo_details_by_id($id){
...
function delete_advertisement_video($id)
{
		$this->db->where('video_id', $id);
        $this->db->delete('stream_advertisement_video');
		return true;
}


function delete_artist_follow($id)
{
