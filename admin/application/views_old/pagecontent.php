						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									  $page_id=stripslashes($details[$i]['page_id']);
									  $page_tittle=stripslashes($details[$i]['page_title']);
							
							   $page_content=stripslashes($details[$i]['page_content']);
							   ...
							   //$type_language=stripslashes($details[$i]['type_language']);
								...
								<tr>
                                     <td style="visibility:hidden;display:none;"><?=$page_id?></td>
									<td>
										 <?=$page_tittle?>
									</td>
                                 ...
                                 <td>
                                         ...
                                         <span class="label label-sm label-<?=$status_list[$page_status];?>"> <?=$page_status?> </span>
									...
									<td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/update_pagecontent/<?=$page_id?>">
										Edit </a>
                                    ...
                                    <td>
										<!--<a class="edit" href="javascript:;">
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/delete_pagecontent/<?=$page_id?>">
										Delete </a>
