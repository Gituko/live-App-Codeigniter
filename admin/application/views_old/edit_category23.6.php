        ...
        <div class="tab-pane active" id="tab_general">
			...
			?>
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="category_name" id="category_name" placeholder=""  value="<?=$meta_title;?>" >
                    </div>
                    </div> 
                    </div>
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="category_name" id="category_name" placeholder=""  value="<?=$meta_tag;?>" >
                    </div>
                    </div> 
                    </div>
             ...
             <div class="form-group">
                    <label class="col-md-2 control-label"> Category Image: <span class="required">
                    * </span>
                    </label>
