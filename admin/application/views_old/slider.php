			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/slider">Sliders list</a>							
                            <i class="fa fa-angle-right"></i>
						</li>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									    $slider_name=stripslashes($details[$i]['slider_name']);
										$slider_image=stripslashes($details[$i]['slider_image']);
										$slider_status=stripslashes($details[$i]['slider_status']);
										$slider_id=stripslashes($details[$i]['slider_id']);
								...
								?>
								<tr>
                                     <td style="visibility:hidden;display:none;"><?=$slider_id?></td>
									<td>
										 <?=$slider_name?>
									</td>
                                   <td>
                                  <img src ='<?php echo site_base_url('uploads/slider_image/'. $slider_image); ?>' width='100' height='80'>
                                  </td>
									<td>
                                         <span class="label label-sm label-<?=$status_list[$slider_status];?> "> 
									...
									<td>
                                        ...
                                        <a  href="<?php echo base_url();?>main/edit_slider/<?=$slider_id?>">
										Edit </a>
                                       
									</td>
									<td>
										<a href="<?php echo base_url();?>main/delete_slider/<?=$slider_id?>">
										Delete </a>
									</td>
