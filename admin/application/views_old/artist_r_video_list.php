						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<tr>
                                    ...
                                    <td>
                                  <img src ='<?php echo site_base_url('uploads/artist_recorded_video/'. $recorded_video_name); ?>' width='100' height='80'>
                                  </td>
                                ...
                                <td>
                                   ...
                                   <td>
									...
									<td>
                                         <span class="label label-sm label-<?=$status_list[$recorded_v_status];?>"> <?=$recorded_v_status?> </span>
