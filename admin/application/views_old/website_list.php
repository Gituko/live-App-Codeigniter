			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/cat_list">Category Details</a>							
                           <!-- <i class="fa fa-angle-right"></i>-->
						</li>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
                                ...
                                <?
								 ...
								 {
									  $web_id=stripslashes($details[$i]['web_id']);
									  $website_name=stripslashes($details[$i]['website_name']);
									   $website_link=stripslashes($details[$i]['website_link']);
									 // $where=stripslashes($details[$i]['where']);
									 $website_image=stripslashes($details[$i]['website_image']);
									 //$cat_thumb_img=stripslashes($details[$i]['cat_thumb_img']);
							   $website_status=stripslashes($details[$i]['website_status']);
								...
								<tr>
                                     <td style="visibility:hidden;display:none;"><?=$web_id?></td>
									<td>
										 <?=$website_name?>
									</td>
                                  ...
                                  <td>
                                    ...
                                    <!-- <td><img src ='<?php echo site_base_url('uploads/cat_image/'. $cat_image); ?>' width='100' height='80'></td>-->
                                    
                                    
                                    
									<td>
                                         <span class="label label-sm label-<?=$status_list[$website_status];?>"> <?=$website_status?> </span>
									...
									<td>
										...
										Edit </a>-->
                                        <a  href="<?php echo base_url();?>main/edit_website/<?=$web_id?>">
										Edit </a>
									...
									<td>
                                    	...
                                    	Delete </a>-->
                                        <a  href="<?php echo base_url();?>main/delete_website_list/<?=$web_id?>">
										Delete </a>
									</td>
