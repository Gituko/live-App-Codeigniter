						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<tr>
                                  ...
                                  <td>
                                  <? if($image==''){?>
									  <img src ='<?php echo site_base_url('uploads/user_image/blank_images.gif'); ?>' width='100' height='80'>
								 <? }else{?>
                                  ...
                                  <td>
                                     ...
                                     <td>
										<a  href="<?php echo base_url();?>main/artist_add_image/<?=$artist_id?>">
										Add </a><br/><br/>
                                        <a  href="<?php echo base_url();?>main/artist_list_image/<?=$artist_id?>">
										List </a>
									</td>
                                     <td>
										<a  href="<?php echo base_url();?>main/artist_add_video/<?=$artist_id?>">
										Add </a><br/><br/>
                                    ...
                                    <td>
										<a  href="<?php echo base_url();?>main/artist_add_r_video/<?=$artist_id?>">
										Add </a><br/><br/>
