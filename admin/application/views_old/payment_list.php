...
<div class="container">
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/payment_details">Payment list</a>							
                            <i class="fa fa-angle-right"></i>
						</li>
                  ...
                  <?php 
					   ...
					   $form_action="main/search_payment_list";
				  ?>
			   <form class="form-horizontal form-row-seperated" id="form_sample_product" name="form_sample_product"   method="post" action="<?=base_url();?><?=$form_action?>">  
       ...
       $search_end_date='';
	    ...
	    for($i=0;$i<count($details);$i++)
								 
		 {
			 ...
			 $admin_charge=stripslashes($details[$i]['admin_charge']);
			$total_amount=$total_amount+$payment;
			$total_artist_charge=$total_artist_charge+$artist_charge;
			$total_admin_charge=$total_admin_charge+$admin_charge;
		 }
 ...
 .border_btm{
	 border-bottom:1px solid #dedede;
                    ...
                    <i class="fa"></i>
                    <input type="text" class="form-control datepicker-here" name="search_start_date" id="start" placeholder=""  value="<?=$search_start_date;?>" >
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control datepicker-here" name="search_end_date" id="end" placeholder=""  value="<?=$search_end_date;?>" >
                    </div>
                    </div>
                    ...
                    <input type="submit" class="form-control input-small input-inline" name="submit" id="start" placeholder=""  value="Submit" >
                              ...
                              <div class="table-toolbar border_btm">
								...
								//echo "<pre>"; print_r($details); die;
								 ...
								 {		
								 		$order_no=stripslashes($details[$i]['order_no']);
								 		$name=stripslashes($details[$i]['name']);
										$user_name=stripslashes($details[$i]['user_name']);
									    $user_type=stripslashes($details[$i]['user_type']);
						...
						<div class="details">
							...
							<div class="desc">
								 ...
								 <div class="col-md-2"><font size="3" color="black">Total Amount :</font></div><div class="col-md-2"><font size="3" color="red"><?=$total_amount?></font></div>
                                  <div class="col-md-2"><font size="3" color="black">Total Admin Charge:</font></div><div class="col-md-2"><font size="3" color="red"><?=$total_admin_charge?></font></div>
                                  <div class="col-md-2"><font size="3" color="black">Total Artist Charge:</font></div><div class="col-md-2"><font size="3" color="red"><?=$total_artist_charge?></font></div>
