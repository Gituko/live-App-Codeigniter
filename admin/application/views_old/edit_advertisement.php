        ...
        <div class="tab-pane active" id="tab_general">
            ...
            <?php
			   ...
			   if(!empty($details) && $advertisement_id!='')
			   {
					...
					$advertisement_place=stripslashes($details[0]['ad_place']);	
			...
			?>
                    ...
                    * </span>
                    ...
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="advertisement_name" id="advertisement_name" placeholder=""  value="<?=$advertisement_name;?>" >
                    </div>
                    </div>  
                    </div>
                    ...
                    <label class="col-md-2 control-label">Advertiser Name<span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="advertiser_name" id="advertiser_name" placeholder=""  value="<?=$advertiser_name;?>" >
                    </div>
                    </div>  
                    </div><?php */?>
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label">Advertisement Page: <span class="required">
                    * </span>
                    </label>
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium" name="page" id="page" >
                    <option value="">Select...</option>
                    <option value="home" <? if($advertisement_page=='home') { ?> selected <? } ?>>Home</option>
                   
                    <option value="artist_details" <? if($advertisement_page=='artist_details') { ?> selected <? } ?>>Artist Details</option>     
                  <!--  <option value="category_price_listing" <? if($advertisement_page=='category_price_listing') { ?> selected <? } ?>>Category_price_listing</option>-->
                    ...
                    * </span>
                    ...
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium" name="ad_place" id="ad_place" >
                    <option value="">Select...</option>
 ...
 <!------------------------------------------------------------------- display image Section---------------------------------------------------------------------------->
                    ...
                    * </span>
                    ...
                    <input type="hidden" class="form-control" name="hid_advertisement_image" id="hid_advertisement_image" placeholder=""  value="<?=$advertisement_image; ?>" >
                        ...
                        {
                        ?>
                       <img src="<?=site_base_url()."uploads/advertisement_image/thumb/thumb_".$advertisement_image;?>"> 
                       <?
                        }
                       ?>
                       </div>
				...
				$('#end').appendDtpicker({
                  ...
                  <div class="form-group">
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
        <input type="date`" class="form-control datepicker-here" name="advertisement_end_date" id="end" placeholder=""  value="<?=$advertisement_end_date;?>" >
                    </div>
                    </div>  
                    </div>
