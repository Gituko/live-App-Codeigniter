...
<head>
<?php
$page_name='add_artist_recorded_video';
...
<div class="container">
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo base_url(); ?>main/artist_add_video">Add video</a>
							<i class="fa fa-angle-right"></i>
						</li>
				...
				<div class="row">
					...
					if(!empty($details) && $artist_id!='')
			          {
						  $form_action="main/artist_edit_r_video/".$artist_id;
					  }
					  else
					  {
						  $form_action="main/artist_add_r_video/".$artist_id;
					  }
					?>
    ...
    <div class="tab-content no-space">
        <div class="tab-pane active" id="tab_general">
            <div class="form-body">
            <?php
	$user_name=stripslashes($detail[0]['name']);
			
			   if(!empty($details) && $recorded_v_id!='')
			   {
				   
					$video_id=stripslashes($details[0]['video_id']);
					$recorded_v_title=stripslashes($details[0]['recorded_v_title']);
					$recorded_video_name=stripslashes($details[0]['recorded_video_name']);
					$artist_id=stripslashes($details[0]['artist_id']);
					$recorded_v_status=stripslashes($details[0]['recorded_v_status']);
					$recorded_v_overview=stripslashes($details[0]['recorded_v_overview']);
					$price=stripslashes($details[0]['price']);
			...
			?>
                    ...
                    * </span>
                    ...
                    <div class="form-group">
                    <label class="col-md-2 control-label">Video Title<span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="recorded_v_title" id="recorded_v_title" placeholder=""  value="<?=$recorded_v_title;?>" >
                    </div>
                    </div>  
                    </div>
                     ...
                     <div class="form-group">
                    <label class="col-md-2 control-label">Video upload<span class="required">
                    * </span>
                    </label>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="file" class="form-control" name="recorded_video_name" id="recorded_video_name" placeholder=""  value="<?=$recorded_video_name;?>" >
                    </div>
                    </div>  
                    </div>
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <textarea rows="4" cols="50" class="form-control" name="recorded_v_overview" id="recorded_v_overview" placeholder=""  value="<?=$recorded_v_overview;?>">
                    </textarea>
                    </div>
                    </div>  
                    </div>
                ...
                <div class="form-group">
                    ...
                    * </span>
                    ...
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium" name="recorded_v_status" id="recorded_v_status" >
                    <option value="">Select...</option>
                    <option value="Show" <? if($recorded_v_status=='Show') { ?> selected <? } ?>>Show</option>
                    <option value="Hide" <? if($recorded_v_status=='Hide') { ?> selected <? } ?>>Hide</option>                  
                    </select>
                    </div>
                    </div>
