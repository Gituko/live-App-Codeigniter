...
<div class="logo">
	<a href="index.html">
	<img src="<?php echo base_url();?>assets/admin/layout2/img/logo.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form id="login_form" name="login_form" method="post" class="login-form" action="<?php echo base_url(); ?>main/forgot_password" >
		<h3 class="form-title">Enter Your Email Id</h3>
        <?php 
		
		if(@$check=='true'){?>
		 <div class="alert alert-success ">
        <button class="close" data-close="alert"></button>
         Password send successfully into your email id
        </div>
