			...
			<div class="page-content">
				...
				<div class="row">
					...
					if(!empty($details) && $artist_id!='')
			          {
						  $form_action="main/artist_edit_video/".$artist_id;
					  }
					  else
					  {
						  $form_action="main/artist_add_video/".$artist_id;
					  }
					?>
	...
	$user_name=stripslashes($detail[0]['name']);
			...
			?>
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="text" class="form-control" name="video_title" id="video_title" placeholder=""  value="<?=$video_title;?>" >
                    </div>
                    </div>  
                    </div>
                    ...
                    * </span>
                    ...
                    <div class="input-icon right">
                    <i class="fa"></i>
                    <input type="file" class="form-control" name="video_name" id="video_name" placeholder=""  value="<?=$video_name;?>" >
                    </div>
                    </div>  
                    </div>
                    ...
                    * </span>
                    ...
                    <div class="col-md-10">
                    <select class="table-group-action-input form-control input-medium" name="video_status" id="video_status" >
                    <option value="">Select...</option>
                    <option value="Show" <? if($video_status=='Show') { ?> selected <? } ?>>Show</option>
                    <option value="Hide" <? if($video_status=='Hide') { ?> selected <? } ?>>Hide</option>                  
                    </select>
                    </div>
                    </div>
