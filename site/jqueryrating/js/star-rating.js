...
(function (factory) {
    ...
    Rating.prototype = {
		...
		//	alert(id);
            ...
            //return '<span class="' + css + '">' +val+ caption + '</span>';
			//return val;
			return '<input  type="hidden" name="rate_number[]" id="rate_number" value="'+val+'" >';
        },
        ...
        setStars: function (pos) {
			...
			//alert(id);
			//document.getElementById("show_rating_1").value=out.val;
