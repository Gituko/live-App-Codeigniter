...
$route['edit_video_artist'] = 'main/edit_video_artist';
$route['edit_video_artist/(:any)'] = "main/edit_video_artist/$1";

//
$route['payment_scheduled_live'] = 'main/payment_scheduled_live';
$route['payment_scheduled_live/(:any)'] = "main/payment_scheduled_live/$1";


$route['video_category'] = 'main/video_category';
$route['video_category/(:any)'] = "main/video_category/$1";

//$route['video_offline'] = 'main/video_offline';
//$route['video_offline/(:any)'] = "main/video_offline/$1";


$route['user_purchase'] = 'main/user_purchase';
$route['user_purchase/(:any)'] = "main/user_purchase/$1";

$route['artist_income'] = 'main/artist_income';
$route['artist_income/(:any)'] = "main/artist_income/$1";

$route['artist_message_video'] = 'main/artist_message_video';
$route['artist_message_video/(:any)'] = "main/artist_message_video/$1";

$route['go_live'] = 'main/go_live';
$route['go_live/(:any)'] = "main/go_live/$1";

$route['add_live_form'] = 'main/add_live_form';
$route['add_live_form/(:any)'] = "main/add_live_form/$1";

$route['thankyou'] = 'main/thankyou';
$route['thankyou/(:any)'] = "main/thankyou/$1";


$route['tip_form'] = 'main/tip_form';
$route['tip_form/(:any)'] = "main/tip_form/$1";

$route['tips_payment'] = 'main/tips_payment';
$route['tips_payment/(:any)'] = "main/tips_payment/$1";

$route['banned'] = 'main/banned';
$route['banned/(:any)'] = "main/banned/$1";

$route['user_following_streamer'] = 'main/user_following_streamer';
$route['user_following_streamer/(:any)'] = "main/user_following_streamer/$1";



$route['normal_video_view'] = 'main/normal_video_view';
$route['normal_video_view/(:any)'] = "main/normal_video_view/$1";

//$route['online_schedule'] = 'main/online_schedule';
//$route['online_schedule/(:any)'] = "main/online_schedule/$1";

$route['stremer_message'] = 'main/stremer_message';
$route['stremer_message/(:any)'] = "main/stremer_message/$1";

$route['user_upgrade'] = 'main/user_upgrade';
$route['user_upgrade/(:any)'] = "main/user_upgrade/$1";

$route['private_message'] = 'main/private_message';
$route['private_message/(:any)'] = "main/private_message/$1";


$route['add_private_message'] = 'main/add_private_message';
$route['add_private_message/(:any)'] = "main/add_private_message/$1";


$route['user_private_message'] = 'main/user_private_message';
$route['user_private_message/(:any)'] = "main/user_private_message/$1";


$route['artist_private_message'] = 'main/artist_private_message';
$route['artist_private_message/(:any)'] = "main/artist_private_message/$1";
