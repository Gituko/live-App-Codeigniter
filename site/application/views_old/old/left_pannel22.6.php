...
<div class="panel_holder2">
	 ...
	 ?>
                                		 <img src="<?php echo site_base_url(); ?>uploads/user_image/<?php echo $detail[0]['image']; ?>" id="file_preview_1">
                                          <?php } else { ?>
       <img src="<?php echo base_url(); ?>img/man2.png" id="file_preview_1">
       <?php } ?>
                                    </div>
                                </div>
						...
						?>
                            <ul class="nav nav-tabs leftli">
                                ...
                                <li><a href="<?=site_base_url()?>photos"><i class="fa fa-music myicon blue"></i>Photoes</a></li>
                              <!--  <li><a href="myaccount(step4).html"><i class="fa fa-level-up myicon blue"></i>My Profile</a></li>
                                ...
                                <!--<li><a href="myaccount(step6).html"><i class="fa fa-desktop myicon blue"></i>My Portfolio</a></li>-->
                                 <li <?php if($id2=='myportfolio'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>myportfolio"><i class="fa fa-user myicon blue"></i>My Portfolio</a></li>
                                <!--<li><a href="myaccount(step7).html"><i class="fa fa-laptop myicon blue"></i>Edit Portfolio</a></li>-->
                                <li <?php if($id2=='edit_portfolio'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>edit_portfolio"><i class="fa fa-list-alt myicon blue"></i>Edit Portfolio</a></li>
    ...
    if (typeof FormData !== 'undefined') {
        ...
        $.ajax({
            ...
            success : function(data) {
				...
				var image="<?=site_base_url()?>uploads/user_image/"+data.trim();
