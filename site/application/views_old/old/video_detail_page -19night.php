               ...
               <?php
                            ...
                            <div class="chat_inputbox">
                                ...
                                <div id="dropchat2" class="chat_icons">
                                	<div class="chat_ico"><img src="<?php echo base_url(); ?>chat_images/alien1.png" onClick="return emoji_images();"></div>
                                    <div class="chat_ico"><img src="<?php echo base_url(); ?>chat_images/alien2.png"></div>
                                    <div class="chat_ico"><img src="<?php echo base_url(); ?>chat_images/angel.png"></div>
                                    <div class="chat_ico"><img src="<?php echo base_url(); ?>chat_images/angry.png"></div>
                                    <div class="chat_ico"><img src="<?php echo base_url(); ?>chat_images/annoyed.png"></div>
                                    <div class="chat_ico"><img src="<?php echo base_url(); ?>chat_images/blanco.png"></div>
