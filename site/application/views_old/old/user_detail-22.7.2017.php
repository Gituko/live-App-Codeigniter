...
<section id="videodetail">
	...
	?>
                                    ...
                                    <div class="userareas">
                                    	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 userinfo_left">
                                        	<h5>Interested In:</h5>
                                            <p><?=$atrist_details[0]['interested_in'];?></p>
                                        </div>
                                    
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 userinfo_left">
                                        	<h5>Ethnicity:</h5>
                                            <p><?=$atrist_details[0]['ethnicity'];?></p>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 userinfo_left">
                                        	<h5>Orientation:</h5>
                                            <p><?=$atrist_details[0]['orientation'];?></p>
                                        </div>
                                    </div>
                                    <div class="userareas">
                                    	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 userinfo_left">
                                        	<h5>Body Type:</h5>
                                            <p><?=$atrist_details[0]['body_type'];?></p>
                                        </div>
                                   
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 userinfo_left">
                                        	<h5>Hair Color:</h5>
                                            <p><?=$atrist_details[0]['haircolor'];?></p>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 userinfo_left">
                                        	<h5>Eye Color:</h5>
                                            <p><?=$atrist_details[0]['eyecolor'];?></p>
                                        </div>
                                    </div>
                                    <div class="userareas">
                                ...
                                <div class="feature_video_holder">
                                    ...
                                    <div class="f_video_bottom vdodetel">
                                        ...
                                        <div class="vdodetel_bottom">
                                        	...
                                        	<span class="vdodetel_vew_link"><a class="fancybox fancybox.iframe"  href="<?php echo site_base_url();?>recorded_video_view/<?php echo $row1['recorded_v_id'];?>">View</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
