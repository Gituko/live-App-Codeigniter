									 ...
									 foreach($details as $row)
									 {
                                      ...
                                      <div class="gn_row" id="shc_<?=$i?>">
                                        ...
                                        <div id="edit_date<?=$i?>" style="display:none">
                                        	<input type="text" class="form-control edit_gi_box" name="date_<?=$i?>" id="date_<?=$i?>" value="<?=$row['date'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <?=$row['time'];?>
                                        	...
                                        	<input type="text" class="form-control edit_gi_box" name="time_<?=$i?>"  id="time_<?=$i?>"value="<?=$row['time'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <?=$row['duration'];?>
                                        	...
                                        	<input type="text" class="form-control edit_gi_box" name="duration_<?=$i?>"  id="duration_<?=$i?>"  value="<?=$row['duration'];?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3 new_div">
                                        <div id="intro_text<?=$i?>">
