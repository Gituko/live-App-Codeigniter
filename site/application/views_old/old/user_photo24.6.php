...
//echo $handicapper_image;	 ?>
 ...
 <div class="choose_images">
 	<div id="files" >
               ...
               <img src="<?=site_base_url()?>uploads/user_photo/<?php echo $row['image']; ?>" alt="" height="100" width="150" id="alu_img_<?=$i?>">
        ...
        $.ajax({
            ...
            success : function(data) {
				if(data=="empty"){
					...
					var image="<?=site_base_url()?>/uploads/user_photo/"+data.trim();
