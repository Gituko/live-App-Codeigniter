                           ...
                           <div id="menu2" class="allcourses">
                                 ...
                                 <div class="col-md-12 as_info">
                                    	<div class="gn_info">
                                            ...
                                            <div class="col-md-6 gn_title">
                                            	<a href="myaccount(sep_4).html">Edit</a>
                                            </div>
                                            <div style="clear:both"></div>
                                        </div><!---end gn_info---->
                                        ...
                                        <div style="display:block;" id="bill1" class="gn_body hide2">
                                        	...
                                        	<div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['name'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['birth_date'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['sex'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['interested_in'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['location'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['last_broadcast'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['language_known'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['body_type'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['about_me'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            ...
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['orientation'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                             ...
                                             <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['haircolor'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['eyecolor'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            <div class="gn_row">
                                                ...
                                                <div class="col-md-8 gi_title_right">
                                                	<h6><?php echo $user_details[0]['ethnicity'];?></h6>
                                                </div>
                                                <div style="clear:both"></div>
                                            </div><!---end gn_row---->
                                            <div style="clear:both"></div>
