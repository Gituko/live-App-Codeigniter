	...
	<div class="myaccountdiv">
       ...
       $search='';
							...
							<div style="display:block; padding-top:0;" id="panel22" class="Panel-content">
                                ...
                                <div style="border-top:none;" class="pb">
                                    ...
                                    <div class="example">
                                      ...
                                      <div>
                                     <input type="text" class="form-control edit_gi_box search_text" onBlur="filter_list(<?=$category_id?>)" name="search" id="search1" value="<?=$search?>" />
                                      </div>
							...
							<div style="display:block; padding-top:0;" id="panel22" class="Panel-content">
                                ...
                                <div style="border-top:none;" class="pb">
                                    ...
                                    <div class="example">
                                      ...
                                      <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 panel_date">
                                      	<input type="text" class="form-control edit_gi_box valid datepicker" name="from_date" id="from_date" onChange="filter_list(<?=$category_id?>)"  placeholder="From Date"/>
             
                                        
                                      </div>
                                     <!-- <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 panel_time">
                                        <input type="text" class="form-control edit_gi_box valid datetimepicker" name="from_time" id="from_time" onChange="filter_list(<?=$category_id?>)"  placeholder="From Time"/>
                                      </div>-->
                                      <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 panel_date">
                                      	<input type="text" class="form-control edit_gi_box valid datepicker1" name="to_date"  id="to_date" onChange="filter_list(<?=$category_id?>)"   placeholder="From Date"/>
                                      </div>
                                     <!-- <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 panel_time">
                                        <input type="text" class="form-control edit_gi_box valid datetimepicker1" name="to_time"   id="to_time" onChange="filter_list(<?=$category_id?>)"  placeholder="To Time"/>
                                      </div>-->
                                       <div style="clear:both"></div>
                                     <style>
									 .dd{
        ...
        <?php /*?>                    
                	...
                	<div class="f_title">
                    	<h2><?php echo $category_name[0]['category_name'];?></h2>
                    </div>
...
function filter_list(id,page){
	var search_name = document.getElementById('search1').value;
	
	var from_date = document.getElementById("from_date").value;
	var to_date = document.getElementById("to_date").value;
	//alert(from_date);
	
		var calendar = document.getElementsByName("hair_color[]");
	...
	var eye_color="";
		...
		$.ajax({
			   ...
			   url:"<?=site_base_url()?>filtering_page?intertest="+intertest+"&body="+body+"&orientation="+orientation+"&hair_color="+hair_color+"&ethnicity="+ethnicity+"&eye_color="+eye_color+"&cat_id="+id+"&page="+page+"&age="+age+"&online_status="+online_status+"&search_name="+search_name+"&from_date="+from_date+"&to_date="+to_date,
