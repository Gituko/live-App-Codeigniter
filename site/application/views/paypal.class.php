...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      <div style="max-width:1000px; margin:150px auto 0; padding:60px 0; border:solid 1px #666; box-shadow:0 0 5px 1px #999;">
      <?
      echo "<center><h2 style=\"color:#39a3c5; font-size:22px; font-family:arial;\">Please wait, your order is being processed and you";
      ...
      echo "<h1 style=\"color:#666; font-family:arial; font-size:20px;\"><center>If you are not automatically redirected to paypal within 5 seconds...</center></h1> ";
      //echo "paypal within 5 seconds...<br/><br/>\n";
      echo "<center><input style=\"background: none repeat scroll 0 0 #39a3c5;
    border-radius: 5px;
    color: #fff;
    font-size: 16px;
    font-weight: normal;
	...
	border: medium none;
	cursor:pointer;
    text-align: left;\" type=\"submit\" value=\"Click Here\"></center>\n";
