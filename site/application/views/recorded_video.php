				 ...
				 <div class="myaccount_holder">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 normal_rightpanel">
   						...
   						<div class="myaccount_top_text tab-content">
                            ...
                            <form  name="search_frm" id="search_frm" enctype="multipart/form-data" method="get" action="<?=site_base_url();?>recorded_video">
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-4 col-xs-4 fv_container">
                                <div class="feature_video_holder">
                                    <div class="media-wrapper">
                                        ...
                                        <source src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['recorded_video_name']);?>" type="video/mp4">
                                        <source src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['recorded_video_name']);?>" type="video/ogg">
                                        <source src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['recorded_video_name']);?>" type="video/webm">
                                        <object data="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['recorded_video_name']);?>" width="470" height="255">
                                        <embed src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['recorded_video_name']);?>" width="470" height="255">
                                        </object>
                                        </video>
                                    </div>
