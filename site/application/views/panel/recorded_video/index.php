	...
	<div class="myaccountdiv">
		<div class="container-full">
         ...
         <div class="row">
			...
			if(strlen($row['recorded_v_title'])>20){
									$more_pop = "....";
								}else{
									$more_pop = "";
								}
...
<!--                                        <video style="width: 314px; height: 176px;" onclick="myFunction<?=$j?>()" id="myVideo<?=$j?>" poster="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo $row['image']; ?>" width="100%" height="100%" style="max-width:100%;">
                                        <source src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['video_key']);?>.mp4" type="video/mp4">
                                        <object data="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['video_key']);?>" width="470" height="255">
                                        <embed src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo($row['video_key']);?>" width="470" height="255">
                                        </object>
                                        </video>-->
                                        <a href="<?=site_base_url();?>artist_message_video/<?=urlencode(str_replace(" ","_",$row['recorded_v_title']))._.$row['recorded_v_id']?>"><img style="width: 100%; height: 255px;" class="img responsive" src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo $row['image']; ?>"></a>
                                    </div>
                                    <div class="f_video_bottom">
                                        <h5><a href="<?=site_base_url();?>artist_message_video/<?=urlencode(str_replace(" ","_",$row['recorded_v_title']))._.$row['recorded_v_id']?>"><?php echo substr($row['recorded_v_title'],0,20) .$more_pop;?></a>
