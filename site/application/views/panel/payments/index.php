                                    ...
                                    <div class="col-md-12 as_info">
                                        <div class="gn_info">
                                            <div class="col-md-6 gn_title">
                                                <h5><strong>List of Payments </strong> 
                                                    <?php if($_SESSION['type']=="Artist"){ ?>
                                                    <a href="<?php site_base_url() ?>payments/request_payments">Request payment</a></h5>
                                                    <?php } ?>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Amount (<?php echo $total_notes; ?> notes)</th>
                                                        <th>Date</th>                                                        
                                                        <th>Video</th>
                                                        <th>Type</th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    $i=1;
                                                    foreach($lista as $k) {
                                                        $video=$this->stream->find("stream\stream_recorded_video",$k['video_id']);
//                                                        echo "<pre>";
//                                                        
//                                                        var_dump($video);
//                                                        echo "</pre>";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo date("m-d-Y H:i",  strtotime($k['fecha'])); ?></td>
                                                        <th ><a href="<?php echo site_base_url(); ?>category/video_offline/<?php echo $k['video_id'] ?>"><?php echo $video->recorded_v_title; ?></a></th>
