        	...
        	<div class="container-fluid">
        		...
        		<div id="foo" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 video_detaile_left_body2">
                	...
                	<div class="details_body">
                            <div class="row">
                                <div id="slideleftpanel" class="col-lg-4 col-md-4 col-sm-12 col-xs-12 " >
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 details_video2">
                        	<div class="media-wrapper">
                                <video class="videoimages" width="100%" height="100%" style="max-width:100%;" poster="" preload="yes" controls controlsList="nodownload">
                            ...
                            <div class="messagearea">
                              ...
                              <div class="vscroller vscroller6">
                                ...
                                <? if(count($messages_chat)>50){ ?>
                                 ...
                                 <div id="message_chat" style="max-height: 400px; overflow: scroll;">
               ...
               <?php
                           ...
                           <textarea onkeyup="send_message_chat(event);" class="form-control chatinputarea content"  rows="1"  id="text_message" placeholder="Your text here..." ></textarea>
                                </div> 
                	...
                	<div class="left_panel">
                        ...
                        <div class="chat_reply">
                        	<div class="chat_title"><h4>Chat Replay</h4></div>
                             ...
                             <div id="chat_sms" style=" max-height: 500px; overflow: scroll;">
                            ...
                            <div class="chat_inputbox">
                                ...
                                foreach($my_smilies_data as $key=>$data) {
									?>
                                    <div class="chat_ico" onClick="emoji('<?=$key?>','text_message1')"><?php echo $data ?> </div>
                                ...
                                <div id="dropchat" class="chat_textbox" >
                                    <textarea onkeyup="send_message(event);" class="form-control chatinputarea content"  rows="1"  id="text_message1" placeholder="Your text here..." ></textarea>
                                </div>
...
//}
 ...
 //alert(recorded_v_id);
   ...
   setInterval(function(){ get_chats_new(); }, 300);
    setInterval(function(){ get_chats(); }, 3000);
//   setInterval(function(){ get_chats_new(); }, 5000000);
  //  setInterval(function(){ get_chats(); }, 300000);
   //// setInterval(function(){ get_messsage_chat(); }, 300);
     ...
     <script type="text/javascript">
		...
		$("#chatbttn3").click(function(){
                    $("#dropchat3").slideToggle("slow").css({top:"-228px",position:"relative","z-index":"10000","width":"100%"});
		});
		});
   ...
   window.onload=function(){
	   ...
	   get_MESSAGES();
           ...
           //var element2=$("#chat_sms").html();
           //console.log(element2)
   setInterval(function(){ get_chats(); }, 300);
   setInterval(function(){ get_MESSAGES(); }, 400);
   }
   function get_MESSAGES(){
      $.post("<?php echo site_base_url(); ?>panel/artist_message_video/get_messages",{id_video:<?php echo $v_id ?>},function(data){
