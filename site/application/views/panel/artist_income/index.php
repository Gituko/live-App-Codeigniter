...
<section id="myaccount_service">
	...
	?>
                           ...
                           <div class="allcourses">
                                             ...
                                             <form action="<?php echo site_base_url(); ?>panel/artist_income" method="get" name="sign_name" id="sign_name">           
														 ...
														 foreach($artist_income as $row)
														   ...
														   ?>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td class="c_t"><?php 
                                                                    if($row['user_payer_type']=="1"){
                                                                        $usuario=$this->stream->find("stream\stream_artist",$row['user_payer']);
                                                                        echo $usuario->name;
                                                                    }
                                                                    if($row['user_payer_type']=="2"){
                                                                        
                                                                    }
                                                                    //$usuario=$this->stream->find("stream\stream_artist",$row['user'])
                                                                    ?></td>
