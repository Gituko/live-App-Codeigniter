		...
		<div class="container-full">
			<div class="container-fluid">
				 ...
				 <div class="myaccount_holder">
                    ...
                    <div id="artist_private_messages123">
                        ...
                        <div class="chat_inputbox"  id="chat_inputbox" style="display: none">
                           ...
                           <textarea onkeyup="if (event.keyCode == 13) { return send_message(); }" class="form-control chatinputarea content"  rows="1"  id="text_message" placeholder="Your text here..." ></textarea>
                                </div>
              ...
              <div class="panel_holder2">
                           ...
                           <li ><a  onclick="return select_messages(<?php echo $row['user_id']; ?>)"><?=$row['name']?></a></li>      
...
<script>
	...
	function send_message()
	{
	  //alert($("#mydiv")[0].scrollHeight);
	   var message = document.getElementById('text_message').value;
	     var user_id123 = document.getElementById('user_id123').value;
		//alert(user_id123);
 ...
 //alert(recorded_v_id);
	   $.ajax({                              
		type: 'POST',
		url: "<?php echo site_base_url();?>main/message_chat_private?message="+message+"&user_id123="+user_id123,
...
function select_messages(id)
{
	$.ajax({                              
		type: 'POST',
		url: "<?php echo site_base_url();?>main/select_private_message_of_artist?id="+id,
		success:function(response){
	     //alert(response);
