  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="radio"  name="role" onclick="package()" id= "Stremers" value="Stremers" checked> Stremers
       <input type="radio" name="role"  onclick="package()" id= "Viewers" value="Viewers">Viewers
  		 <p style="color:#F00" id="error_role"></p>
           <!-- 
  			<select class="srem">
            	<option value="Stremers">Stremers</option>
      ...
      <div class="form-group" id="package_detail" style="display:none">
