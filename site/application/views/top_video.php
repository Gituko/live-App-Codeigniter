            	...
            	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 fv_container">
                	<div class="feature_video_holder">
                        ...
                        ?>
                                                ...
                                                <a href="<?=site_base_url();?>video_offline/<?=urlencode(str_replace(" ","_",$row1['recorded_v_title']))._.$row1['recorded_v_id']?>"><img src="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo $row1['image']?>" class="popular_img" alt=""></a>
