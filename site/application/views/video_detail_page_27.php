	  ...
	  var artist_id = document.getElementById('artist_id').value;
		...
		success:function(response){
			...
			$('#unfollow').hide();
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 video_detaile_rightpanel">
                	<div class="left_panel">
                        ...
                        <div class="chat_reply">
                            ...
                            <a class="active" href="#" onclick="group_chat();" >Group Chat</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <?php
				...
				?>
                            <a class="chattab" href="#" onClick="private_chat();">&nbsp;&nbsp;Private Chat</a>
                            ...
                            <div class="chat_title" id="private_display" style="display: none"><h4>Chat Replay</h4> 
                            <a class="chattab" href="#" onclick="group_chat();" >Group Chat</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                             <?php
				if($this->session->userdata("is_logged_in")=="TRUE"  && $user_type=="User" ){
				...
				?>
                            <a   class="active" href="#" onClick="private_chat();">&nbsp;&nbsp;Private Chat</a>
