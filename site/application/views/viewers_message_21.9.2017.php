	 ...
	 ?>
       ...
       <?php } ?>
                                            	...
                                            	<div class="col-md-6 gi_title">
                                                	<h6><?=$row['name']?> </h6>
                                                     <p><strong>Video Title:</strong>&nbsp<?php echo $row['recorded_v_title']; ?>
                                                    <a href="<?=site_base_url();?>artist_message_video/<?=urlencode(str_replace(" ","_",$row['recorded_v_title']))._.$row['recorded_v_id']?>">
                                                     (View Details)</a>
                                                    ...
                                                    <p><strong>Message:</strong><?php echo $row['message']; ?></p>
                                                     ...
                                                     <p><strong>Date:</strong><?php echo $date1; ?>&nbsp&nbsp&nbsp<strong>Time:</strong><?php echo $time; ?></p>
