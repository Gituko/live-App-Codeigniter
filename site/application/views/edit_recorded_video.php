...
<?php
					...
					$recorded_id=$_GET['recorded_id'];
				$details=$this->module->get_recorded_video_id($recorded_id);
...
<!--************************************************************************************************************************************-->
                    ...
                    <div id="Div1" class="dashboard">
                            	...
                            	<div class="col-md-12 as_info">
                                    	<div class="gn_info">
                                        	<div class="left_headbox">
                                        		<h2><span class="blues">Edit Recorded Video</span></h2>
                                        	</div>
                                            <div style="clear:both;"></div>
                                        </div><!---end gn_info---->
                      ...
                      <!---------------------------GI tab 2---------------------------> 
                       ...
                       <form class="form-horizontal" action="<?php echo site_base_url(); ?>edit_recorded_video" id="review" method="post" enctype="multipart/form-data">
                                            
                                        <div id="bill2" class="gn_body">
                                        	<div class="left_detailbox">
                                           
                                             
                                               <input type="hidden" class="form-control" name="recorded_id" value="<?php echo $recorded_id;?>"/>
                                             
                                              <div class="linebox">
                                          <!--   <h2>Giver Name:<?php //echo $p_id[0]['giver_username'];?></h2>-->
                                             <h2>Name: </h2>
                                             <input type="text" class="form-control" name="recorded_v_title" value="<?php echo $details[0]['recorded_v_title'];?>"/>
                                             </div>
                  ...
                  <div class="left_detailbox">
                    <i class="fa"></i>
                    <textarea name="recorded_v_overview" class="form-control" rows="5" cols="40"><?php echo $details[0]['recorded_v_overview'];?></textarea>
                 ...
                 <div class="form-group">
                  ...
                  <div class="left_detailbox">
                    <i class="fa"></i>
                   <input type="text" class="form-control" name="price" value="<?php echo $details[0]['price'];?>"/>
                    ...
                    <?php
					$status1= $details[0]['recorded_v_status'];
					?>
                    <div class="col-md-10">
                  <div class="left_detailbox">
                    <i class="fa"></i>
