                            	...
                            	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 topvideo">
                                        ...
                                        <div class="video-container">
                                            <div class="media-wrapper">
                                                <video onclick="myFunction6()" id="myVideo6" class="videoimages" width="100%" height="100%" style="max-width:100%;" poster="<?php echo base_url(); ?>img/videoimg2.png" preload="yes" controls controlsList="nodownload"> 
...
<section id="somework">
		...
		<div class="container-full">
			<div class="container">
			   ...
			   foreach($popular as $row1){ 
            	...
            	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 fv_container">
                	<div class="feature_video_holder">
                    	<div class="vdo_image_index">
                               <?php
                                             if(($this->session->userdata('is_logged_in')=='1') && ($user_type=="User") || ($row1['recorded_video']=="0"))
						{
							
                        ?>
                                                <a href="<?=site_base_url();?>video_offline/<?=urlencode(str_replace(" ","_",$row1['recorded_v_title']))._.$row1['recorded_v_id']?>"><img src="<?php echo base_url(); ?>img/img15.png" class="popular_img" alt=""></a>
				...
				?>
				 <a href="#" onClick="artist()"><img src="<?php echo base_url(); ?>img/img1.png" class="popular_img" alt=""></a> 
                 <?
				}
						else{
			...
			?>
						...
						<a data-toggle="modal" data-target="#myModal" href="#"><img src="<?php echo base_url(); ?>img/img1.png" class="popular_img" alt=""></a>
    ...
    <?php
	$home_add1=$this->module->get_advertisement_home1('home','Top');
 ...
 <?php /*?><div class="google_add_home">
  <?php
    ...
    <?php
		...
		$home_add=$this->module->get_advertisement_home1('home','Bottom');
		foreach($home_add as $row1)
		{
		?>
                ...
                ?>
				 ...
				 <? }?> 
                  <img src="<?=site_base_url()."uploads/advertisement_image/".$picture1[array_rand($picture)];?>"/>
                <? 
                //print_r($picture1);
				?>
                        	<!--<img src="<?php echo base_url(); ?>img/googleadd3.png" alt="">-->
