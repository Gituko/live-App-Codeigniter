...
<section id="videodetail">
	<div class="worksection">
		<div class="container-full">
                    <div class="container" style="margin:0px; padding: 0px; padding-left: 1px; max-width: 100%">
                        <div id="foo" class="col-lg-9 col-md-9 col-sm-9 col-xs-12 video_detaile_left_body" style="padding-right: 0px">
  ...
  <!-- If need to support IE8 -->
                        ...
                        <div class="media-wrapper" style="width: 100%; float: left">
                            <video id="live-m3u8-01" width="100%" height="500" style="width: 100%;"  poster="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo  $custom_video[0]['image']; ?>" class="video-js vjs-default-skin vjs-big-play-centered " 
                                        preload="auto" controls  controls controlsList="nodownload">
                                          <source
                                             src="http://173.255.192.230/videos/live/<?php echo $custom_video[0]['video_key'];?>/index.m3u8"
                                             type="application/x-mpegURL">
                                         </video> <script> var player = videojs('live-m3u8-01'); player.play(); </script>
	  ...
	  var artist_id = document.getElementById('artist_id').value;
		...
		success:function(response){
			...
			$('#unfollow').hide();
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 video_detaile_rightpanel" style="padding-left: 0px">
                    <div class="left_panel" style="padding-top: 0px; margin-top: -8px">
                        ...
                        <div class="chat_reply">
                        	<div class="chat_title" id="group_display"><h4>Chat Replay</h4> 
                            <a class="active" href="#" onclick="group_chat();"  id="group_chat">Group Chat</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <?php
				if($this->session->userdata("is_logged_in")=="TRUE"  && $user_type=="User" ){
				...
				?>
                            ...
                            <div id="group_chat_display">
                                ...
                                <div class="vscroller vscroller2" style="height: 290px">
                        	 <div class="vscroller-content">  
                            ...
                            <div class="chat_inputbox">
                            	<div class="chat_togle_btn">
                                    ...
                                    <button class="sendicon chaticon" data-placement="top" title="Send"  onClick="return send_message(); return false;"><i class="fa fa-location-arrow"></i></button>
...
//$("#result_video").hide();recorded_sort
		...
		function check_function(){
			if(document.getElementById('group_chat').className=='active'){
			get_chats_new();
			}else{
			private_chat();
			}
