...
.hide_follow{
	display:none;
						...
						<?php if($user_type=="User"){ ?>
                            ...
                            <div class="follow_sec">
                             ...
                             <a  class="iframe_review123" href="<?=site_base_url()?>private_message?artist_id=<?php echo $atrist_details[0]['artist_id'];?>"><span class="gapp"></span>Message</a>
  ...
  <video id="live-m3u8-01" width="960" height="540" class="video-js vjs-default-skin vjs-big-play-centered" 
preload="auto" controls>
  <source
     src="http://69.164.195.148/videos/live/01405756/index.m3u8"
