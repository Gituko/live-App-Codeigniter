...
<!--            <video   id="video_baner" style="width: 100%;"  controlsList="nodownload">
        ...
        <div class="col-md-8" style="padding-left: 0px; padding-right: 0px;">
            ...
            <div class="col-md-12" id="videoContainer">
                ...
                <video autoplay id="video" playsinline iphone-inline-video webkit-playsinline webkit-playsinline="true" playsinline="true" style="width: 100%; height: auto"  controlsList="nodownload">
                         ...
                         <a   data-toggle="modal" data-target="#myModal_message" onclick="clear_validation_message()"><span class="gapp"></span>Message</a>  
                            ...
                            <div class="vd_bottom">
                                ...
                                <div class="vb_usrdetail">
                                    ...
                                    <p>Tag Words:<span class="gapp"></span>  <?php
							  $i=1;
							 foreach($tag as $row1){
							//http://www.streamact.com/category/video?/1=1&tag=asdfas
							 ?>
							...
							//print_r($checking_like);
								...
								?>
                                    ...
                                    <div class="view" style="float: right; clear: both; margin-top: -40px;"><a href="" onclick="return false;"><?php  echo date("d-m-Y",  strtotime($custom_video[0]['video_date']));  ?></a></div>
...
<!--                        <div class="addsec">
        ...
        <script>
            function updateScroll2(){
                  var element = document.getElementById("artist_private_messages123");
                  element.scrollTop = element.scrollHeight;
              }
              $(document).ready(function(){
                  updateScroll2()
             ...
             <div id="private_chat_display" style="display: none">
                            ...
                            <div class="vscroller vscroller2" style="height: 60vh">
                        	 <div class="vscroller-content">  
                             
                                     <div id="artist_private_messages123" style="height: 49vh; overflow-y: scroll;">
                            </div>
                           ...
                           <textarea onkeyup="if (event.which == 13 || event.keyCode == 13) { send_message_private();}" class="form-control chatinputarea content"  rows="1"  id="text_message_private" placeholder="Your text here..." ></textarea>
                                </div>
