                                        ...
                                        <div class="video-container">
                                            <div class="media-wrapper">
                                                <video onclick="myFunction6()" id="myVideo6" class="videoimages" width="100%" height="100%" style="max-width:100%;" poster="<?php echo base_url(); ?>img/videoimg2.png">
                                                    ...
                                                    <object data="<?php echo site_base_url(); ?>uploads/admin_video/<?php echo $video_admin[0]['video'];?>" width="470" height="255">
			   ...
			   foreach($popular as $row1){ 
            	...
            	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 fv_container">
                	<div class="feature_video_holder">
                        ...
                        ?>
                                                <a href="<?=site_base_url();?>video_offline/<?=urlencode(str_replace(" ","_",$popular[$h]['recorded_v_title']))._.$popular[$h]['recorded_v_id']?>"><img src="<?php echo base_url(); ?>img/img15.png" class="popular_img" alt=""></a>
