                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 details_video2">
                            ...
                            <div class="form_section">
                            	<div class="col-lg-6 col-md-6 col-xs-6 col-sm-12 strm_frm_col_left">
                                    ...
                                    <div class="strm_form_sec">
                                    	<p>Overview:</p>
                                        <textarea name="recorded_v_overview" class="form-control strm_input" cols="4" rows="6"></textarea>
                                    </div>
                                </div>
                                
                                <div class="col-lg-6 col-md-6 col-xs-6 col-sm-12 strm_frm_col_right">
                                	<div class="strm_form_sec">
                                    	<p>Video Tags (Write video tags like toys,Newyork):</p>
                                        <textarea name="video_tags" class="form-control strm_input" cols="4" rows="6"></textarea>
                                    </div>
