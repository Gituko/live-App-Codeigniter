	...
	<div class="worksection">
		<div class="container-full">
        	<div class="container" style="margin:0px; padding: 0px; padding-left: 1px; max-width: 100%">
        		<div id="foo" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 video_detaile_left_body" style="padding-right: 0px">
...
<!--                                <video class="videoimages" width="100%" height="100%" style="max-width:100%;" poster="<?php echo base_url(); ?>img/vd_image.png" preload="yes" controls controlsList="nodownload">
                                    ...
                                    <embed src="<?php echo site_base_url(); ?>uploads/arists_video/<?php echo $custom_video[0]['recorded_video_name'];?>" width="470" height="255">
                                      ...
                                      <video class="videoimages" width="100%" height="100%" style="max-width:100%;" poster="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo $custom_video[0]['image']; ?>" preload="yes" controls controlsList="nodownload">
...
<!--                  <div class="videodetails_slider">
			...
			?>                         
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 video_detaile_rightpanel" style="padding:0px; margin:0px ">
				...
				?>
                     ...
                     <div class="messagearea">
                           		<!--<h3>Messages</h3>-->
                                        ...
                                        <div class="vscroller" style="height: 256px" >
