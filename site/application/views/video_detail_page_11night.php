        		...
        		<div id="foo" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 video_detaile_left_body">
                	<div class="details_body">
                    	...
                    	<div class="google_add3">
                         ...
                         <?php
						 $image=$this->module->get_advertisement_videodetail('video_detail','Top');
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 video_detaile_rightpanel">
                	<div class="left_panel">
                    	<div class="addsec">
                              ...
                              <?php
						            $image_right=$this->module->get_advertisement_videodetail('video_detail','Right');
...
function emoji(code){
 ...
 document.getElementById('text_message').value=message1;
                    ...
                    <?php
						            $image_bottom=$this->module->get_advertisement_videodetail('video_detail','Bottom');
