                            ...
                            <div class="col-lg-4 col-md-4 col-xs-4 col-xs-4 fv_container">
                                <div class="feature_video_holder">
                                    <div class="media-wrapper">
                                        <video onclick="myFunction<?=$j?>()" id="myVideo<?=$j?>" poster="<?php echo site_base_url(); ?>uploads/recorded_video/<?php echo $row['image'] ?>" width="100%" height="100%" style="max-width:100%;">
