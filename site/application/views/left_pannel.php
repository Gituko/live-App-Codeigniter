       ...
       <?php } ?>
						...
						?>
                           ...
                           <li <?php if($id2=='go_live'){ ?> class='active'<?php }?>><a class="go_live"  href="<?=site_base_url()?>go_live"><i class="fa fa-video-camera myicon blue"></i>Go Live</a></li>      
                              ...
                              <li <?php if($id2=='photos'){ ?> class='active'<?php }?>><a href="<?=site_base_url()?>photos"><i class="fa fa-music myicon blue"></i>Photos</a></li>
                        ...
                        <li <?php if($id2=='payment_setting'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>payment_setting"><i class="fa fa-lock myicon blue"></i>Payment Setting</a></li>          
                             ...
                             <li <?php if($id2=='user_upgrade'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>user_upgrade"><i class="fa fa-lock myicon blue"></i>Upgrade </a></li>   
                               
                               
                                
                              <li <?php if($id2=='user_purchase'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>user_purchase"><i class="fa fa-lock myicon blue"></i>My Purchase</a></li>
                              
                               <li <?php if($id2=='user_following'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>user_following_streamer"><i class="fa fa-lock myicon blue"></i>My Following Streamers</a></li>
                               
                               
                               <li <?php if($id2=='user_private_message'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>user_private_message"><i class="fa fa-lock myicon blue"></i>My Personal Messages</a></li>
                     ...
                     <li <?php if($id2=='stremer_message'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>stremer_message"><i class="fa fa-lock myicon blue"></i>Messages</a></li>           
                              
                              
                              
                                
                      <li <?php if($id2=='artist_income'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>artist_income"><i class="fa fa-lock myicon blue"></i>My Income</a></li>
                      
                      <li <?php if($id2=='artist_private_message'){ ?> class='active'<?php }?>><a href="<?php echo site_base_url()?>artist_private_message"><i class="fa fa-lock myicon blue"></i>My Personal Messages</a></li>
