 ...
 *******************************************************************************
*/
//paypal_stream_act.class
class paypal_stream_act {
   ...
   function __construct($cmd="_xclick") {
      ...
      $this->ipn_log_file = $_SERVER['DOCUMENT_ROOT'].'/log/.ipn_results.log';
...
//      echo "<input type=\"submit\" value=\"Click Here\"></center>\n";
   ...
   function validate_ipn() {
      ...
      if (strcmp("/VERIFIED/i",$this->ipn_response)) {
