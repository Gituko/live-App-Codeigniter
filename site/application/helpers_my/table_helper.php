<!--<script>
var xmlHttp_product_details_new;

function move_joborder(quotation_id)
{	 
//alert(quotation_id);
	xmlHttp_product_details_new=GetXmlHttpObject_amount_time();
	if (xmlHttp_product_details_new==null)
	 {
		alert ("Browser does not support HTTP Request");
		return;
	 }
		 
	var	url= "<?=$site_url?>application/views/quotations/move_to_joborder.php?quotation_id="+quotation_id;
		//alert(url);
		
		xmlHttp_product_details_new.onreadystatechange=product_detail ;
		xmlHttp_product_details_new.open("GET",url,true);
		xmlHttp_product_details_new.send(null);
		return false;

function product_detail() 
 { 
	if (xmlHttp_product_details_new.readyState==4)
	{
		
		 var temp=xmlHttp_product_details_new.responseText;
		 alert(temp);
		 window.location="<?=$site_url?>index.php/quotations";
...
/*
Gets the html table to manage quotations.
*/
